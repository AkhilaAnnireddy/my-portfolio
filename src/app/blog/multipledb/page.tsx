  ...
  return (
    <div className="min-h-screen px-6 py-12 bg-black text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <ul className="list-disc list-inside mb-4 text-blue-100">
          ...
          <li>
            <strong>Multiple Databases (Recommended for full isolation)</strong>
          </li>
        </ul>
    ...
    protected Object determineCurrentLookupKey() {
      return TenantContext.getCurrentTenant();
        ...
        <p className="mb-4 text-blue-100">
          At JP Morgan, I implemented dynamic tenant routing to support internal
          tools that required strict data segregation. This helped us onboard
          new clients faster without compromising existing configurations.
        </p>
        ...
        <p className="text-blue-100">
          ...
          efficiently while maintaining full tenant data isolation. With Spring
          Boot's flexibility, it's easier than ever to architect robust
