export default function SCIMArticle() {
    ...
    <div className="min-h-screen px-6 py-12 bg-gradient-to-b from-black via-blue-900 to-blue-700 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4 text-blue-100 leading-relaxed">
          ...
          and provides CRUD operations via HTTP methods. Some key endpoints in a
          SCIM-compliant service are:
        </p>
        <ul className="list-disc list-inside mb-6 text-blue-100 leading-relaxed">
          <li>
  ...
  "active": true
        ...
        <p className="mb-4 text-blue-100 leading-relaxed">
          SCIM APIs are typically secured using OAuth 2.0 bearer tokens. You can
          authenticate requests by sending the token in the `Authorization`
          header:
        </p>
        <pre className="bg-blue-950 text-blue-100 p-4 rounded-lg text-sm overflow-x-auto mb-6">
        ...
        <p className="mb-4 text-blue-100 leading-relaxed">
          ...
          automate user onboarding across internal systems. This reduced manual
          ticket-based provisioning by 65%, enhanced data consistency, and
          enabled real-time deprovisioning for compliance.
        </p>
        ...
        <ul className="list-disc list-inside text-blue-100 leading-relaxed">
          <li>
            <strong>Java/Spring:</strong> <code>spring-scim2</code>, custom REST
            controllers
          </li>
          <li>
        ...
        <p className="text-blue-100 leading-relaxed">
          SCIM streamlines identity management in modern applications. If you're
          building SaaS products or managing users across systems, SCIM 2.0 is a
          must-know protocol. With a bit of setup, it can save hours of manual
          provisioning and ensure secure, scalable identity automation.
        </p>
      </div>
    </div>
  );
