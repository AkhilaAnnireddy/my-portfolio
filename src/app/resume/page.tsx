        ...
        <div className="mt-12 space-y-12">
          ...
          >
            ...
            <div>
              ...
              <p className="text-blue-200">
                Masters in Data Science (GPA: 3.8/4.0)
              </p>
          ...
          >
            ...
            <div>
              ...
              <ul className="mt-2 list-disc list-inside text-blue-200">
                <li>
                  Built a Faster Whisper-based video-to-text system and
                  classified tutor/student talk moves with analytics dashboard
                  in React.
                </li>
                <li>
                  Designed fault-tolerant architecture using AWS Lambda, S3, and
                  SQS; improved processing scalability.
                </li>
                <li>
                  Reduced AWS costs by 25% through auto-scaling and spot
                  instances while enhancing system performance.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-6">
              ...
              <ul className="mt-2 list-disc list-inside text-blue-200">
                <li>
                  Delivered 50+ user stories for a client-facing app using Java,
                  React, Spring Boot, and Agile workflows.
                </li>
                <li>
                  Migrated 4 applications to AWS with 99.9% uptime, saving 30%
                  in infra costs using a parallel lift-and-shift model.
                </li>
                <li>
                  Implemented SCIM-based REST APIs automating onboarding &
                  compliance, reducing manual effort by 65%.
                </li>
                <li>
                  Led 20+ zero-downtime deployments using Jenkins, Blue-Green
                  strategy, and AWS stack.
                </li>
                <li>
                  Resolved 70+ issues with deep Splunk-driven RCA, improving
                  resolution time by 45%.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-6">
              ...
              <ul className="mt-2 list-disc list-inside text-blue-200">
                <li>
                  Created Maker-Checker workflow with Spring & React to enhance
                  audit and security traceability.
                </li>
                <li>
                  Boosted automation by 50% via CI/CD pipelines integrated with
                  S3 & vulnerability scans.
                </li>
                <li>
                  Handled backend upgrade workflows, reducing release friction
          ...
          >
            ...
            <ul className="list-disc list-inside text-blue-200">
              <li>
                <strong>StackStats:</strong> Created a StackOverflow portfolio
                builder using ReactJS & ChartJS.
              </li>
              <li>
                <strong>EduBlog:</strong> Developed a Django-based university
                social media platform.
              </li>
              <li>
                <strong>Autism Prediction:</strong> Designed a 3D CNN model
                achieving 90% accuracy using ABIDE fMRI data.
              </li>
              <li>
                <strong>Pharmaceutical Wastewater Detection:</strong> Built ML
                models to detect drug compound levels in sewage using regression
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-blue-200">
              <p>
                <strong>Languages:</strong> Java, Python, JavaScript, C, C++,
                SQL
              </p>
              <p>
                <strong>Web Development:</strong> React, Spring Boot, Flask,
              ...
              <p>
                <strong>Cloud & DevOps:</strong> AWS, Docker, Terraform,
                Jenkins, GitHub Actions
              </p>
              <p>
                <strong>APIs:</strong> RESTful APIs, SCIM API, FastAPI
              </p>
              <p>
                <strong>Tools & Testing:</strong> Selenium, JUnit, Cucumber,
                Mockito, Splunk, Jira
              </p>
            </div>
          </motion.section>
